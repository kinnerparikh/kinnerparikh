...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelor of Science, Computer Science}{September 2023 - June 2025}
          \resumeItemListStart
...
\section{Experience}
  ...
  \resumeSubheading
    ...
    {RhythmsAI}{Bellevue, WA}
    \resumeItemListStart
      \resumeItem{Building an AI-powered operating system to enable enterprises to understand, streamline, and orchestrate their rhythms, enabling every team to become a super team}
      \resumeItem{Full stack engineering to architect and build our entire product!}
    \resumeItemListEnd

  \resumeSubheading
    {Undergraduate Research Assistant}{September 2024 -- March 2025}
    {UbiComp Lab -- Paul G. Allen School of Computer Science \& Engineering}{Seattle, WA}
    \resumeItemListStart
      \resumeItem{Created a system to crowd source the amount of ambient light on a street using commodity smartphones and publish that data to help inform local officials}
...
\section{Projects}
    ...
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
          {\textbf{Ski Instructor, Husky Winter Sports}}{Seasonal, January 2024 -- March 2025}
          \resumeItemListStart
